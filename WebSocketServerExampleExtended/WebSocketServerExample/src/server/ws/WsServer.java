...
public class WsServer {
	...
	public void onMessage(String message, Session session) throws IOException {
		...
		synchronized (clients) {
			// THIS IS  A HACK. I concatenated the name of the item here (see WSC.jsp)
			// You should have a JSON wit all this info i.e. Item ID, item name, price, timestamp 
			// Here I just concatenated the name of the item for simpliity. Normally
			// should be a JSON attribute, so you send to the server a JSON message
			...
			// Iterate over the connected sessions pertaining to the specific item
			// and multicast the received message
